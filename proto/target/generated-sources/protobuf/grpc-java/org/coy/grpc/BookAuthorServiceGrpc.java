...
public final class BookAuthorServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.coy.grpc.BookAuthorService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<org.coy.grpc.Author,
      org.coy.grpc.Author> METHOD_GET_AUTHOR =
      io.grpc.MethodDescriptor.<org.coy.grpc.Author, org.coy.grpc.Author>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "org.coy.grpc.BookAuthorService", "getAuthor"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.coy.grpc.Author.getDefaultInstance()))
  ...
  public static abstract class BookAuthorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getAuthor(org.coy.grpc.Author request,
        io.grpc.stub.StreamObserver<org.coy.grpc.Author> responseObserver) {
  ...
  public static final class BookAuthorServiceBlockingStub extends io.grpc.stub.AbstractStub<BookAuthorServiceBlockingStub> {
     ...
     * </pre>
     */
    public org.coy.grpc.Author getAuthor(org.coy.grpc.Author request) {
  ...
  public static final class BookAuthorServiceFutureStub extends io.grpc.stub.AbstractStub<BookAuthorServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.coy.grpc.Author> getAuthor(
        org.coy.grpc.Author request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AUTHOR:
          serviceImpl.getAuthor((org.coy.grpc.Author) request,
              (io.grpc.stub.StreamObserver<org.coy.grpc.Author>) responseObserver);
          break;
        default:
  ...
  private static final class BookAuthorServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.coy.grpc.Schema.getDescriptor();
    }
  }
